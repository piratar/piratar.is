...
<div id="boxin_kynning">
    <div class="wrapper">
        <div class="box" style="height:270px;">
            <?php the_field('frontbox_left', 456); ?>
        </div>
        ...
        <div class="box" style="height:270px;">
			<?php the_field('frontbox_right', 456); ?>
        </div>
    </div>
</div>
...
<div class="frettir">  
    <div class="wrapper">
	<h2 class="section-title"><a href="/piratar-a-thingi/frettir/">Fréttir</a></h2>
		<div class="ord">
			<div class="box nedrabox" style="height:360px;">
				<?php the_field('frontbox_lover_right', 456); ?>            
			</div>
		</div>
		<?php 
            $i = 1;
